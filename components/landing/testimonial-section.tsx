...
const testimonials = [
  ...
  },
  {
    ...
    quote: 'Awalnya ragu, tapi ternyata prosesnya mudah dan hasilnya nyata. Terima kasih Hafta atas bantuannya.',
    context: 'Nyeri Leher',
    rating: 5,
  },
  {
...
function TestimonialCard({ testimonial }: { testimonial: (typeof testimonials)[0] }) {
  return (
    <div className="mx-3 w-[calc(100vw-2rem)] max-w-[350px] shrink-0 rounded-xl border border-border bg-white p-6">
      ...
      <div className="mt-4 border-t border-border pt-4">
        <p className="font-medium text-foreground">{testimonial.displayName}</p>
      ...
      <Container>
        <ScrollAnimation>
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-2xl font-bold tracking-tight text-foreground md:text-3xl">Apa Kata Mereka</h2>
            <p className="mt-3 text-muted-foreground">Pengalaman pasien yang telah menjalani terapi bersama kami</p>
            <p className="mt-2 text-xs text-muted-foreground/70">* Testimonial ditampilkan dengan persetujuan pasien</p>
          </div>
        </ScrollAnimation>
      </Container>
