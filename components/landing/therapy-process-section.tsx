      ...
      <Container>
        <ScrollAnimation>
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-2xl font-bold tracking-tight text-foreground md:text-3xl">Proses Terapi</h2>
            <p className="mt-3 text-muted-foreground">Langkah-langkah yang akan Anda lalui selama program pemulihan</p>
          </div>
        </ScrollAnimation>
