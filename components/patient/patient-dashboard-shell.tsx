            ...
            <DropdownMenu>
              <DropdownMenuTrigger className="flex items-center gap-3 rounded-xl p-1.5 transition-colors hover:bg-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent">
                ...
                <div className="hidden min-w-0 flex-col text-left sm:flex">
                  ...
                  <span className="truncate text-xs text-muted-foreground">@{userEmail || 'pasien'}</span>
                </div>
                <ChevronDown className="hidden h-4 w-4 shrink-0 text-muted-foreground sm:block" />
              </DropdownMenuTrigger>
              <DropdownMenuContent align="end" className="w-56">
                <div className="px-3 py-2">
                  <p className="text-sm font-bold text-foreground">{userName || 'Pasien'}</p>
                  <p className="text-xs text-muted-foreground">@{userEmail || 'pasien'}</p>
                </div>
                <DropdownMenuSeparator />
