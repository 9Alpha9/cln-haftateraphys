...
const navigation = [
  ...
  { name: "Data Saya", href: "/dashboard/profile", icon: User },
  { name: "Form Awal", href: "/dashboard/intake", icon: ClipboardList },
  { name: "Riwayat", href: "/dashboard/history", icon: History },
  { name: "Keamanan", href: "/dashboard/security", icon: Shield },
];
