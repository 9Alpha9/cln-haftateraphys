    ...
    <DropdownMenu open={isOpen} onOpenChange={handleOpenChange}>
      ...
      <DropdownMenuContent className="w-[min(20rem,calc(100vw-2rem))] sm:w-80">
          ...
          {notifications.length === 0 ? (
            ...
            notifications.map((notif) => (
              <DropdownMenuItem
                key={notif.id}
                className={cn(
                  "flex flex-col items-start gap-1 p-3 focus:bg-muted",
        ...
        <Link
          ...
          className="flex items-center justify-center gap-1 px-3 py-2 text-sm font-medium text-primary hover:underline"
        >
